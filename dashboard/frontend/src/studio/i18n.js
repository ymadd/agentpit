...
export const JA = {
  ...
  "just now": "たった今",
  // workspace loops (board, inbox, blueprints, canvas)
  "Loops": "ループ",
  "Board": "ボード",
  "Inbox": "受信箱",
  "Blueprints": "ブループリント",
  "{n} running": "{n} 件実行中",
  "{n} waiting for you": "{n} 件があなた待ち",
  "daemon connected": "デーモン接続中",
  "daemon unreachable": "デーモンに接続できません",
  "connecting…": "接続中…",
  "The desktop bridge is not available.": "デスクトップのブリッジが使えません。",
  "No loops yet — start one from Blueprints, or `agentpit loop start`.": "ループはまだありません — ブループリントから開始するか、`agentpit loop start` を使ってください。",
  "Hide finished": "終了分を隠す",
  "Show {n} finished": "終了した {n} 件を表示",
  "waiting for you": "あなた待ち",
  "parked · waiting for you": "退避中 · あなた待ち",
  "no runner": "ランナーなし",
  "paused": "一時停止中",
  "stopping": "停止中",
  "not started": "未開始",
  ...
  "cancelled": "取り消し",
  "created": "未開始",
  "{n} gate(s) open": "ゲート {n} 件",
  "{n} instruction(s) queued": "指示 {n} 件待ち",
  "steps {v}": "ステップ {v}",
  "compute {v}": "計算 {v}",
  "Pause": "一時停止",
  "Resume": "再開",
  ...
  "Stop": "停止",
  "Stop now": "今すぐ停止",
  "Stop this loop? Running steps finish first.": "このループを停止しますか？ 実行中のステップは完了を待ちます。",
  "Stop now, cancelling running steps?": "実行中のステップを取り消して今すぐ停止しますか？",
  "Nothing is waiting for you.": "あなた待ちのものはありません。",
  "Recently answered": "最近の回答",
  "parked — answering wakes it": "退避中 — 答えると起動します",
  "Comment (optional, passed to the next step)": "コメント（任意。次のステップに渡されます）",
  "Blocking question": "ブロッキングの質問",
  "Review": "レビュー",
  "Approve": "承認",
  "Reject": "却下",
  ...
  "{n} error(s)": "エラー {n} 件",
  "{n} warning(s)": "警告 {n} 件",
  "hidden by the project blueprint of the same name": "同名のプロジェクトのブループリントが優先されます",
  "Design": "設計",
  "Run": "実行",
  "Start…": "開始…",
  "Delete": "削除",
  "Studio sketches on this machine": "このマシンの Studio スケッチ",
  "No drawn sketches found.": "描いたスケッチが見つかりません。",
  "{n} steps": "{n} ステップ",
  "Import": "取り込む",
  "Save as blueprint": "ブループリントとして保存",
  "Imported, with notes:": "取り込みました（注意点）:",
  "OK": "OK",
  "Start {name}": "{name} を開始",
  "Working directory": "作業ディレクトリ",
  "Title (optional)": "タイトル（任意）",
  "Start right away": "すぐに開始する",
  "Starting…": "開始中…",
  "No loop of this blueprint yet — Start it from the design side.": "このブループリントのループはまだありません — 設計側から開始してください。",
  "Loading…": "読み込み中…",
  "Read-only: {why}": "読み取り専用: {why}",
  "Instruction for {node}'s next step…": "{node} の次のステップへの指示…",
  "Instruction for the next agent step…": "次のエージェントのステップへの指示…",
  "Send": "送信",
  "following": "追従中",
  "phase": "状態",
  "assignee": "担当",
  "iteration": "反復",
  "iterations": "反復数",
  "Cancel this step": "このステップを取り消す",
  "Click a node to see its steps and output.": "ノードをクリックすると、ステップと出力が見られます。",
  "Add a {kind} node": "{kind} ノードを追加",
  "JSON": "JSON",
  "Canvas": "キャンバス",
  "Unsaved": "未保存",
  "Save": "保存",
  "{e} error(s), {w} warning(s)": "エラー {e} 件、警告 {w} 件",
  "This blueprint changed on disk": "このブループリントはディスク上で変更されています",
  "Someone saved it since you opened it (now {rev}). Your edits are still here.": "開いた後に誰かが保存しました（現在 {rev}）。あなたの編集はここに残っています。",
  "It was deleted since you opened it. Your edits are still here.": "開いた後に削除されました。あなたの編集はここに残っています。",
  "Keep editing": "編集を続ける",
  "Discard mine and reload": "自分の編集を捨てて読み直す",
  "Overwrite with mine": "自分の編集で上書き",
  "Save mine again": "自分の編集を保存し直す",
  "Apply": "適用",
  "This loop's blueprint is not a file in a blueprint directory; showing its frozen copy.": "このループのブループリントはブループリントのディレクトリにないため、凍結されたコピーを表示しています。",
  "options (empty = approve / reject)": "選択肢（空 = 承認／却下）",
  "＋ option": "＋ 選択肢",
  "follow when the source ends": "起点の終わり方がこれなら進む",
  "blueprint": "ブループリント",
};
